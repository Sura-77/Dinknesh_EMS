...
import { User, LogOut, Ticket, Calendar, LayoutDashboard, Shield, Sun, Moon } from 'lucide-react';
      ...
      <nav className="sticky top-0 z-50 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link to="/admin/dashboard" className={`text-sm flex items-center gap-2 ${location.pathname === '/admin/dashboard' ? 'text-white' : 'text-gray-400 hover:text-white'}`}>
