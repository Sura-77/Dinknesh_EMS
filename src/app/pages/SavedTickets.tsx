                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-6 mb-4">
                      <div className="flex items-center gap-3">
                        <button onClick={() => handleUpdateQuantity(reservation.id, reservation.quantity - 1)}
          ...
          <div className="lg:col-span-1">
            <div className="rounded-xl shadow-sm p-6 sticky top-24 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
              ...
              <button onClick={handleCheckout}
                className="w-full px-4 py-3 rounded-lg font-semibold mb-4 transition-colors bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100">
                Proceed to Checkout
              </button>
              <Link to="/discover" className="block text-center text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                Continue Shopping
              </Link>
