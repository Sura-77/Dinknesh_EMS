        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="rounded-xl shadow-sm p-6 sticky top-24 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
              ...
              <button onClick={handlePayWithChapa} disabled={processing} className="w-full px-4 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 transition-colors disabled:opacity-50 bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100">
                {processing
