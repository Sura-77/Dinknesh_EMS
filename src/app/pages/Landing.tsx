      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-24 px-6">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Link to="/discover" className="px-8 py-4 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg">
              Discover Events
            </Link>
            <Link to="/organizer/signup" className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors">
              Create Event
            </Link>
          </div>
            ...
            {[
              {
                title: 'For Attendees',
                steps: [
                  { n: 1, title: 'Discover Events', desc: 'Browse featured, trending, and nearby events' },
                  { n: 2, title: 'Reserve Tickets', desc: 'Save your tickets and complete checkout within 15 minutes' },
                  { n: 3, title: 'Get Digital Tickets', desc: 'Access your tickets with QR codes instantly' },
                ],
              },
              {
                title: 'For Organizers',
                steps: [
                  { n: 1, title: 'Create Account', desc: 'Register as an organizer and get verified' },
                  { n: 2, title: 'Setup Event', desc: 'Add details, tickets, and manage your team' },
                  { n: 3, title: 'Track & Earn', desc: 'Monitor sales, check-ins, and revenue in real-time' },
                ],
              },
            ].map(({ title, steps }) => (
              <div key={title}>
      ...
      <section className="py-20 px-6 bg-gray-900 dark:bg-gray-800 text-white transition-colors">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/discover" className="px-8 py-4 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              Explore Events
            </Link>
            <Link to="/organizer/signup" className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors">
              Become an Organizer
