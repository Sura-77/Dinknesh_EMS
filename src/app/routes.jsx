...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'events', Component: Discover },
      { path: 'events/:eventId', Component: EventDetail },
      { path: 'login', Component: Login },
      { path: 'signup', Component: Signup },
      { path: 'forgot-password', Component: ForgotPassword },
      { path: 'saved-tickets', Component: SavedTickets },
      { path: 'my-tickets', Component: MyTickets },
      { path: 'checkout', Component: Checkout },
      { path: 'profile', Component: Profile },
      { path: 'saved-events', Component: SavedEvents },
      { path: 'organizer/signup', Component: OrganizerSignup },
      ...
      { path: 'security/scanner', Component: SecurityScanner },
