...
router.post('/scan', authenticate, requireRole('security', 'staff', 'organizer', 'admin'), async (req: AuthRequest, res: Response) => {
...
router.get('/event/:id/stats', authenticate, requireRole('security', 'staff', 'organizer', 'admin'), async (req: AuthRequest, res: Response) => {
