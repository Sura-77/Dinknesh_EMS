...
async function main() {
  ...
  const orgData = [
    { email: 'techhub@dems.et', name: 'TechHub Ethiopia', org: 'TechHub Ethiopia', type: 'corporate' as const },
    { email: 'addislive@dems.et', name: 'Addis Live Productions', org: 'Addis Live Productions', type: 'corporate' as const },
    { email: 'heritage@dems.et', name: 'Ethiopian Heritage Foundation', org: 'Ethiopian Heritage Foundation', type: 'non_profit' as const },
    { email: 'gallery@dems.et', name: 'National Gallery Ethiopia', org: 'National Gallery Ethiopia', type: 'government' as const },
    { email: 'athletics@dems.et', name: 'Ethiopian Athletics Federation', org: 'Ethiopian Athletics Federation', type: 'non_profit' as const },
    { email: 'startup@dems.et', name: 'Startup Ethiopia', org: 'Startup Ethiopia', type: 'corporate' as const },
    { email: 'cultural@dems.et', name: 'Ethiopian Cultural Society', org: 'Ethiopian Cultural Society', type: 'non_profit' as const },
    { email: 'bizleaders@dems.et', name: 'Business Leaders Forum', org: 'Business Leaders Forum', type: 'corporate' as const },
  ];
