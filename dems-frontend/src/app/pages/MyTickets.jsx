    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 mb-8">You don't have any tickets. Start exploring events and book your first ticket!</p>
          <a href="/discover" className="inline-block px-6 py-3 bg-gray-900 text-white rounded-lg font-semibold hover:bg-gray-800 transition-colors">Discover Events</a>
        </div>
      </div>
    );
  }
